...
export const createWorkspaceService = async (
  ...
  if (!ownerRole) throw new NotFoundException("Owner roles not found");
...
//! GET ALL WORKSPACE FOR PARTICULAR USER
export const getAllWorkspaceUserIsMemberService = async (userId: string) => {
  ...
  console.log("Member ships check ::::::", memberShips);

  // Extract workspace details form memberships
